...
public class LiteBle {
    ...
    public static final String ACTION_BLE_DISCONNECT = "com.odenble.ACTION_BLE_DISCONNECT";
    public static final String BLE_DISCONNECT_ID = "com.odenble.BLE_DISCONNECT_ID";
